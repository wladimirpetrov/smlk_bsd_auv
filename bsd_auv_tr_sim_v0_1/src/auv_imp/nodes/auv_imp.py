...
from avl_bsd_translator.msg import CommandMsg, ActionMsg
...
class HeartbeatPublisher:
    ...
    def __init__(self):
        ...
        self.heartbeat_msg.HEARTBEAT_ROLL = 0.0
        self.heartbeat_msg.HEARTBEAT_PITCH = 0.0
        self.heartbeat_msg.HEARTBEAT_YAW = 0.0
