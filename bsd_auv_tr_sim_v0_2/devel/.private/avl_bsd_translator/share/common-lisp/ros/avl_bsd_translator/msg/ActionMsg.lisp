...
(cl:defmethod cl:initialize-instance :after ((m <ActionMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ActionMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name avl_bsd_translator-msg:<ActionMsg> is deprecated: use avl_bsd_translator-msg:ActionMsg instead.")))

(cl:ensure-generic-function 'ACTION_TYPE-val :lambda-list '(m))
(cl:defmethod ACTION_TYPE-val ((m <ActionMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader avl_bsd_translator-msg:ACTION_TYPE-val is deprecated.  Use avl_bsd_translator-msg:ACTION_TYPE instead.")
  (ACTION_TYPE m))

(cl:ensure-generic-function 'MODE-val :lambda-list '(m))
(cl:defmethod MODE-val ((m <ActionMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader avl_bsd_translator-msg:MODE-val is deprecated.  Use avl_bsd_translator-msg:MODE instead.")
  (MODE m))

(cl:ensure-generic-function 'NAMES-val :lambda-list '(m))
(cl:defmethod NAMES-val ((m <ActionMsg>))
...
(cl:defmethod TYPES-val ((m <ActionMsg>))
...
(cl:defmethod VALUES-val ((m <ActionMsg>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ActionMsg>)))
  ...
  (cl:format cl:nil "#===============================================================================~%# Autonomous Vehicle Library Backseat Driver~%#~%# Description: Defines a ROS message that contains an action~%#===============================================================================~%~%string ACTION_TYPE~%uint8 MODE~%string[] NAMES~%uint8[] TYPES~%string[] VALUES~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ActionMsg)))
  "Returns full string definition for message of type 'ActionMsg"
  (cl:format cl:nil "#===============================================================================~%# Autonomous Vehicle Library Backseat Driver~%#~%# Description: Defines a ROS message that contains an action~%#===============================================================================~%~%string ACTION_TYPE~%uint8 MODE~%string[] NAMES~%uint8[] TYPES~%string[] VALUES~%~%~%"))
