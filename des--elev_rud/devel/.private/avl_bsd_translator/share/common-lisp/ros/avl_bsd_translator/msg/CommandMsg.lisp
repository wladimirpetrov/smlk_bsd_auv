...
(cl:defmethod cl:initialize-instance :after ((m <CommandMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name avl_bsd_translator-msg:<CommandMsg> is deprecated: use avl_bsd_translator-msg:CommandMsg instead.")))

(cl:ensure-generic-function 'COMMAND_NAME-val :lambda-list '(m))
(cl:defmethod COMMAND_NAME-val ((m <CommandMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader avl_bsd_translator-msg:COMMAND_NAME-val is deprecated.  Use avl_bsd_translator-msg:COMMAND_NAME instead.")
  (COMMAND_NAME m))

(cl:ensure-generic-function 'NAMES-val :lambda-list '(m))
(cl:defmethod NAMES-val ((m <CommandMsg>))
...
(cl:defmethod TYPES-val ((m <CommandMsg>))
...
(cl:defmethod VALUES-val ((m <CommandMsg>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CommandMsg>)))
  ...
  (cl:format cl:nil "#===============================================================================~%# Autonomous Vehicle Library Backseat Driver~%#~%# Description: Defines a ROS message that contains a command~%#===============================================================================~%~%string COMMAND_NAME~%string[] NAMES~%uint8[] TYPES~%string[] VALUES~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CommandMsg)))
  "Returns full string definition for message of type 'CommandMsg"
  (cl:format cl:nil "#===============================================================================~%# Autonomous Vehicle Library Backseat Driver~%#~%# Description: Defines a ROS message that contains a command~%#===============================================================================~%~%string COMMAND_NAME~%string[] NAMES~%uint8[] TYPES~%string[] VALUES~%~%~%"))
