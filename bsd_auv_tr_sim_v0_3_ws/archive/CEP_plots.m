...
plot3(-out.Bx1.signals.values,-out.Bx2.signals.values,out.Bx3.signals.values)
hold on
legend("Bernstein Polynomial","PF w/ adaptation","PF w/o adaptation","TT w/ adaptation","TT w/o adaptation")
grid on
xlabel("x (m)")
ylabel("y (m)")
zlabel("z (m)")
...
grid on
legend("PF, with adaptation","PF, no adaptation")
xlabel("t (s)")
...
grid on
legend("TT, with adaptation", "TT, no adaptation")
xlabel("t (s)")
ylabel("Horizontal Error (m)")
...
grid on
legend("PF, with adaptation","PF, no adaptation","Location","southeast")
xlabel("t (s)")
...
grid on
legend("TT, with adaptation", "TT, no adaptation","Location","southeast")
xlabel("t (s)")
ylabel("Vertical Error (m)")
